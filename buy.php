  ...
  <li class="nav-item">
    ...
    <div class="container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $stmt = $conn->prepare("INSERT INTO customers (ime, prezime, email, telefon, naruceniArtikal, kolicinaNarucenogartikla, cenaNarucenogartikla, datumNarucivanja) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
            $stmt->bind_param("ssssssss", $ime, $prezime, $email, $telefon, $naruceniArtikal, $kolicinaNarucenogartikla, $cenaNarucenogartikla, $datumNarucivanja);
            $stmt->execute();
